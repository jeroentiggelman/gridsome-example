<template>
  <Layout>
    ...
    <h2>Manually coded list of blog posts</h2>

    <ul>
      <li>
        <g-link to="/blog-html/blog-post-one">Blog Post One</g-link>
      </li>
      <li>
        <g-link to="/blog-html/blog-post-two">Blog Post Two</g-link>
      </li>
      <li>
        <g-link to="/blog-html/blog-post-three">Blog Post Three</g-link>
      </li>
    </ul>

    <h2>Automatically generated blog post list</h2>
    ...
    <h2>Reddit Posts in /r/aww from API</h2>
